...
import ru.runa.gpd.algorithms.finality.CheckCorrectFinalityAlgorithm;
...
public class CheckCorrectFinalityAction extends BaseActionDelegate {
    @Override
        ...
        if (editorPart != null) {
            ...
            if (editorInput instanceof FileEditorInput) {
                ...
                if (redTransition != null) {
                    Dialogs.warning(Localization.getString("CheckingFinalityAction.UnlimitedTokens.Message"));
                    return;
                }
                ...
                */
                ...
                CheckCorrectFinalityAlgorithm finalityAlgorithm = new CheckCorrectFinalityAlgorithm(transitions, nodes);
                finalityAlgorithm.startAlgorithm();
                if (finalityAlgorithm.hasIncorrectFinalState()) {
                    Dialogs.warning(Localization.getString("CheckingFinalityAction.SituationExist.Message", finalityAlgorithm.getRedIds()));
                } else {
                    Dialogs.information(Localization.getString("CheckingFinalityAction.SituationNotExist.Message"));
                }
